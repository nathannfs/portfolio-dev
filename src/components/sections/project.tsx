  ...
  return (
    ...
    >
      ...
      <Magnetic className="mt-10 w-fit">
        <Link
          className="inline-flex min-h-[44px] items-center gap-2 py-2 font-mono text-muted-foreground text-sm uppercase tracking-[0.15em] transition-colors hover:text-foreground"
          href="/projects"
        >
          {t("common.viewAll")}
          <ArrowUpRight className="size-4" />
